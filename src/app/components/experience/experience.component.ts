  ...
  <div class="container mx-auto px-6">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <p class="text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-3xl mx-auto">
        1 year of practical experience in Python development and data analytics, creating automated dashboards, analytical models, and visualization systems that transform data into actionable business insights.
  ...
  return [
    {
      ...
      description:
        "Working as a Python Developer focusing on backend API development and data-driven applications. Building RESTful APIs with FastAPI, Flask, and Django, and integrating SQLAlchemy with PostgreSQL databases for scalable systems.",
      companyInitials: "EI",
      companyColor: "from-blue-500 to-blue-700",
      dotColor: "from-blue-500 to-blue-700",
      achievements: [
        "Developed RESTful APIs using FastAPI and Flask for internal tools and client applications",
        "Designed and optimized PostgreSQL schemas with SQLAlchemy ORM",
        "Collaborated with frontend and data teams to build end-to-end analytics workflows",
        "Integrated authentication and role-based access using JWT and OAuth2",
        "Improved API response time and database performance through indexing and query optimization"
      ],
      technologies: [
        "Python",
        "FastAPI",
    ...
    },
    {
      ...
      description:
        "Worked as a Data Analyst Intern, applying Python and Power BI to extract insights from business data. Built interactive dashboards and reports to support decision-making processes.",
      companyInitials: "IA",
      companyColor: "from-green-500 to-green-700",
      dotColor: "from-green-500 to-green-700",
      achievements: [
        "Created 5+ interactive Power BI dashboards improving data visibility by 20%",
        "Analyzed datasets using Python (Pandas, NumPy, Matplotlib, Seaborn)",
        "Handled 10+ GB of business data ensuring data accuracy and compliance",
        "Automated data cleaning and transformation workflows using Python scripts",
        "Collaborated with teams to translate business requirements into analytical reports"
      ],
      technologies: [
        "Python",
        "Pandas",
  ...
  return [
    {
      ...
      description:
        "Designing and developing backend systems and RESTful APIs with modern Python frameworks",
      skills: [
        "Python",
        "FastAPI",
        "Flask",
    ...
    },
    {
      ...
      description:
        "Transforming raw data into actionable insights and predictive models using Python and BI tools",
      skills: [
        "Pandas",
        "NumPy",
        "Scikit-learn",
    ...
    },
    {
      ...
      description:
        "Working efficiently in collaborative environments with modern tools and best practices",
      skills: [
        "Git",
        "GitHub",
        "Agile Methodology",
  ...
  return [
    {
      ...
      description: "In Python development & analytics"
    },
    {
      id: 2,
      icon: "🏢",
      ...
      suffix: "",
      label: "Organizations",
      description: "EPPS Infotech & IANT Pvt Ltd"
    },
    {
      id: 3,
      icon: "🚀",
    ...
    },
    {
      ...
      suffix: "+",
      label: "Technologies",
      description: "Worked across Python, BI, and backend frameworks"
    }
  ];
}
}